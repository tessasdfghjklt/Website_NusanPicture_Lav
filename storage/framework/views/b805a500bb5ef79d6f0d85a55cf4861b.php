        ...
        <ul class="nav-links">
            ...
            <?php if(Route::has('login')): ?>
                <?php if(auth()->guard()->check()): ?>
                    <li><a href="<?php echo e(url('/dashboard')); ?>" class="grey-box">Profile</a></li>
                <?php else: ?>
                    <li><a href="<?php echo e(route('login')); ?>" class="grey-box">Log in</a></li>
                    <?php if(Route::has('register')): ?>
                        <li><a href="<?php echo e(route('register')); ?>" class="grey-box">Register</a></li>
                    <?php endif; ?>
                <?php endif; ?>
            <?php endif; ?>
        </ul>
...
<!-- end of footer --><?php /**PATH C:\Users\Asus\OneDrive\Desktop\Web_Laravel\resources\views/layout/master.blade.php ENDPATH**/ ?>